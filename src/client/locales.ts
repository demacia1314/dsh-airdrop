...
export const zh = {
  ...
  'drop.title': '拖放文件或文件夹到对话',
  'drop.sub': '文件会从当前浏览器上传到 DSH 服务器工作区',
...
export const en = {
  ...
  'drop.title': 'Drop files or folders into the chat',
  'drop.sub': 'Files upload from this browser to the DSH server workspace',
